...
const Navbar = () => {
  return (
    <div className="fixed z-[ 30 ] px-[3rem] top-0 left-0 h-[6vh] flex items-center justify-between w-full bg-gray-100 ">
      <div className="leftNameSide ">
        <TextReveal>
          <h3 className="text-[1.2rem] ">VIRENDRA CHAUDHARI </h3>
        </TextReveal>
      </div>
